 ...
 * @date 2020/12/12
 */
public class ItemViewType1 extends LinearLayout implements ItemView<BModel> {

    private TextView mTextView;

    public ItemViewType1(Context context) {
        this(context, null);
    }

    public ItemViewType1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public ItemViewType1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
